...
class TimeTracker < ActiveRecord::Base
  ...
  before_save do
    ...
    if issue.nil?
      ...
      raise StandardError, l(:tt_error_not_allowed_to_start_tracker_on_issue) if !help.permission_checker([:tt_book_time, :tt_edit_own_bookings, :tt_edit_bookings], issue.project)
